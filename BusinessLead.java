...
public class BusinessLead extends BusinessEmployee{
    ...
    public boolean addReport(Accountant e, TechnicalLead supportTeam){
        ...
        and if the BusinessLead has head count left should add this employee
        ...
        Each time a report is added the BusinessLead's bonus budget should be increased by
        1.1 times that new employee's base salary.
    ...
    public boolean requestBonus(Employee e, double bonus){
        ...
        the BusinessLeader's budget should be deducted and
        true should be returned. False should be returned otherwise
         */
    ...
    public boolean approveBonus(Employee e, double bonus){
        ...
        and if any of them are supporting a the TechnicalLead that is the manager of
        the Employee passed in then the Accountant's budget should be consulted
        to see if the bonus could be afforded.
        If the team can afford the bonus
